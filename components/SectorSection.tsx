...
const sectorsData = [
  { id: 1, title: "Technology, Media & Telecom", slug: "tmt", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1200" },
  { id: 2, title: "Financial Institutions", slug: "financial-institutions", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1200" },
  { id: 3, title: "Metals & Mining", slug: "mining", image: "https://images.unsplash.com/photo-1628487749130-2d41acb1802a?w=900&auto=format&fit=crop&q=60" },
  { id: 4, title: "Industrials", slug: "industrials", image: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&q=80&w=1200" },
  { id: 5, title: "Consumers", slug: "consumers", image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=1200" },
  { id: 6, title: "Healthcare", slug: "healthcare", image: "https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=900&auto=format&fit=crop&q=60" },
  { id: 7, title: "Energy & Utilities", slug: "energy", image: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&q=80&w=1200" },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {sectorsData.map((sector, idx) => (
            <Link key={sector.id} href={`/research/${sector.slug}`}
              // Precise math: 25% minus the shared gap space (18px) to lock the layout
              className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] block group outline-none">
              ...
              <motion.div
                ...
                className="relative w-full aspect-[4/5] border border-white/10 overflow-hidden flex flex-col justify-end p-8 transition-colors duration-500 hover:border-red-900/60 bg-neutral-900/20 will-change-transform"
              >
                {/* IMAGE OVERLAY */}
                ...
                <div className="absolute bottom-0 left-0 w-full h-[3px] bg-red-800 scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-center z-30" />
              </motion.div>
            </Link>
          ))}
        </div>

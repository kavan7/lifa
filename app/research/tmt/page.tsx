...
import Footer from "@/components/ui/footer"; // Assuming your footer is in a separate file
...
export default function SectorPage({ sectorName = "Technology, Media & Telecom" }) {
  return (
      ...
      <div className="relative z-10">
        ...
        <section className="px-6 md:px-12 max-w-7xl mx-auto pt-10 pb-20">
          ...
          >
            ...
            {/* TMT TEXT: Reduced to a cleaner, professional size */}
            ...
            <p className="max-w-xl font-sans text-zinc-400 text-lg leading-relaxed font-light italic">
              Synthesizing cross-border market intelligence and structural data to deconstruct the {sectorName} ecosystem.
            </p>
          </motion.div>
        </section>

...
import { Download, ArrowLeft, Calendar, User, Zap } from "lucide-react";
import Link from "next/link";
import Footer from "@/components/ui/footer"; 

/**
 * ENERGY & UTILITIES SECTOR RESEARCH PAGE
...
export default function EnergySectorPage() {
  const sectorName = "Energy & Utilities";
        ...
        <section className="px-6 md:px-12 max-w-7xl mx-auto pt-10 pb-20">
          ...
          >
            ...
            <p className="max-w-xl font-sans text-zinc-400 text-lg leading-relaxed font-light italic">
              Analyzing the decarbonization of the global power grid and the resilience of regulated infrastructure to deconstruct the {sectorName} ecosystem.
            </p>
          </motion.div>
        </section>

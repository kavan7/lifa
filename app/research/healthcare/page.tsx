...
import { Download, ArrowLeft, Calendar, User, Activity } from "lucide-react";
import Link from "next/link";
import Footer from "@/components/ui/footer"; 

/**
 * HEALTHCARE SECTOR RESEARCH PAGE
 * - Refined Typography
 * - Integrated <Footer />
        ...
        <section className="px-6 md:px-12 max-w-7xl mx-auto pt-10 pb-20">
          ...
          >
            ...
            <p className="max-w-xl font-sans text-zinc-400 text-lg leading-relaxed font-light italic">
              Analyzing the intersection of clinical innovation and capital markets to deconstruct the {sectorName} ecosystem.
            </p>
          </motion.div>
        </section>

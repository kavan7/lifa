...
import { Download, ArrowLeft, Calendar, User, ShoppingBag } from "lucide-react";
import Link from "next/link";
import Footer from "@/components/ui/footer"; 

/**
 * CONSUMERS SECTOR RESEARCH PAGE
 * - Institutional Glass Aesthetic
 * - Integrated <Footer />
...
export default function ConsumersSectorPage() {
  const sectorName = "Consumers";
        ...
        <section className="px-6 md:px-12 max-w-7xl mx-auto pt-10 pb-20">
          ...
          >
            ...
            <p className="max-w-xl font-sans text-zinc-400 text-lg leading-relaxed font-light italic">
              Evaluating consumer sentiment shifts and brand-driven value propositions to deconstruct the {sectorName} ecosystem.
            </p>
          </motion.div>
        </section>

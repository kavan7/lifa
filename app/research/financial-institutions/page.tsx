...
import { Download, ArrowLeft, Calendar, User, Landmark } from "lucide-react";
        ...
        <section className="px-6 md:px-12 max-w-7xl mx-auto pt-10 pb-20">
          ...
          >
            ...
            <p className="max-w-xl font-sans text-zinc-400 text-lg leading-relaxed font-light italic">
              Synthesizing regulatory frameworks and capital market dynamics to deconstruct the {sectorName} ecosystem.
            </p>
          </motion.div>
        </section>
